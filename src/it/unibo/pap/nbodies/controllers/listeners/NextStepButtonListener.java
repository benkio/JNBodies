 ...
 * to do the next step of the n-bodies system's window
 *
 ...
 *
 */
public class NextStepButtonListener implements ActionListener {
     ...
     */
    public NextStepButtonListener(SystemModelThread modelThread,
	...
	SystemModelThread.signalStep();
	SystemViewerThread.signalStep();
    }
