...
public class NBodiesSystemView implements INBodiesSystemView {
    ...
    /**
     * Button that allow to reopen the configuration window and restart the
     * application.
     */
	...
	// properties
	lblNBodies = new JLabel("- Number of bodies: 0", SwingConstants.RIGHT);
	controlConsole.add(lblNBodies);

	// bodies's display and its properties (background color black to
	// simulate the space)
	bodiesDisplay = new BodiesSystemDisplay(model, paintSynchSemaphore);
